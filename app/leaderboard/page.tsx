      ...
      <div className="pt-24 pb-32 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-12">
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-primary mb-4 opacity-100">Leaderboards</h1>
          ...
          <div className="flex justify-center gap-3 mb-8">
            <button
              ...
              className={`px-6 py-2.5 rounded-full font-semibold text-sm uppercase tracking-wide transition-all ${
                selectedPeriod === "all"
                  ? "bg-primary text-black" // Changed from bg-white to bg-primary (yellow/gold)
                  : "bg-transparent text-[#b8b8b8] border border-[rgba(255,215,0,0.2)] hover:border-[rgba(255,215,0,0.4)]"
              }`}
            >
              All Time
            </button>
          ...
          {/* Top Players Section */}
          <div className="rounded-xl border border-[rgba(255,215,0,0.1)] overflow-hidden bg-black/40 backdrop-blur-sm">
            {/* Section Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-[rgba(255,215,0,0.1)] bg-black/60">
            ...
            <div className="flex flex-col items-center justify-center py-20 px-6">
              <div className="w-20 h-20 rounded-full bg-[rgba(255,215,0,0.1)] flex items-center justify-center mb-6">
