    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="pt-24 pb-32 px-6">
        <div className="container mx-auto max-w-7xl">
          {/* Page Header */}
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-primary mb-8 opacity-100">Winners</h1>

          {/* Table Container */}
          <div className="rounded-xl border border-[rgba(255,215,0,0.1)] overflow-hidden bg-black/40 backdrop-blur-sm">
            {/* Table Header */}
            <div className="grid grid-cols-5 gap-4 px-6 py-4 border-b border-[rgba(255,215,0,0.1)] bg-black/60">
